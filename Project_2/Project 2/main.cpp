...
//the hall of fame choice
void HoF (int, char [], char[], pokemon *);//the hall of fame
...
//the purpose of this function is to do the hall of fame
void HoF(int h1, char rival [], char plyr1[], pokemon * v){
    static int count=0;
    
    cout << rival <<": NO! That can't be!" << endl;
    pause(2);
   
    cout << "You beat my best! After all the work to" << endl;
    pause (2);
   
    cout << "become LEAUGE champ? My reign is over already" << endl;
    pause (2);
    cout << "Its not fair! " << endl;
   winner p;
   ...
   for (int x=0;x<3;x++){
       ...
       cout << x+1 << ": " << v[x].name << " HP: " << v[x].health
                 
               << " Type: " << v[x].type << endl;
               
       for (int y=0;y<3;y++){
                  
           cout << v[x].attk[y] << " " << endl;
                }
            }

...
//Declare the variables here
    ...
    //greatest
    printNew(amount,gift);//This function will print the donations from least
    //to greatest
...
//What this function will do is print the donations from least to greatest
void printNew (float *amount, int input){
    //This will print out the array in order
    cout << "The Donations from Least to Greatest: " << endl;
